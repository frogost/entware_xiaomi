# Entware для роутеров Xiaomi в стоке 🚀

Репозиторий содержит инструкции и скрипты для развертывания системы пакетов **Entware** на роутерах Xiaomi. Это позволяет значительно расширить функционал устройства, устанавливая полноценное ПО. Модели: Xiaomi Router BE10000 Pro, Xiaomi Router BE10000, Xiaomi Router BE7000, Xiaomi Mi Router AX9000.
